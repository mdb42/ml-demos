...
####################################################################################################
# The Bigram Language Model with Dropout

class BigramLanguageModel(nn.Module):
    def __init__(self, n_layer, num_heads, head_size, dropout=0.1):
        super().__init__()
        ...
        # Stack multiple Transformer Blocks with Dropout
        self.transformer_blocks = nn.Sequential(*[
            TransformerBlock(num_heads, head_size, dropout=dropout) for _ in range(n_layer)
        ])
