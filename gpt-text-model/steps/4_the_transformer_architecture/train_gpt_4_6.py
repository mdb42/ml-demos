...
class TransformerBlock(nn.Module):
    ...
    def forward(self, x):
        # Communication through multi-head attention
        x = self.multi_head_attention(x)  # Shape (B, T, C)
        # Computation through feedforward network
        x = self.feed_forward(x)  # Shape (B, T, C)
        return x
