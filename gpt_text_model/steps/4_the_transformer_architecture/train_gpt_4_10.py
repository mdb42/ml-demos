...
class BigramLanguageModel(nn.Module):
    def __init__(self):
        ...
        self.transformer_blocks = nn.Sequential(
            TransformerBlock(num_heads, head_size),  # First Transformer Block
            TransformerBlock(num_heads, head_size),  # Second Transformer Block
            TransformerBlock(num_heads, head_size)   # Third Transformer Block (you can add more)
        )
