...
class TransformerBlock(nn.Module):
    ...
    def forward(self, x):
        # Communication through multi-head attention with residual connection
        x = x + self.multi_head_attention(x)  # Residual connection after self-attention
        # Computation through feedforward network with residual connection
        x = x + self.feed_forward(x)  # Residual connection after feedforward layer
        return x
