...
# Update the training loop to call the generate_text_scenarios function at each checkpoint
...
start_epoch = 0
checkpoint_path = 'checkpoints/model_epoch_4100.pth'  # Replace with your checkpoint path
