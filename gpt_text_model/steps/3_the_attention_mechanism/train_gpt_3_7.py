...
batch_size = 32
block_size = 8
C = 32  # Embedding dimensions (renamed from n_embed to C)
learning_rate = 1e-3
eval_interval = 100
eval_iters = 100
...
class BigramLanguageModel(nn.Module):
    def __init__(self):
        super().__init__()
        self.token_embedding_table = nn.Embedding(vocab_size, C)  # Embedding into C dimensions (renamed from n_embed)
        self.LM_head = nn.Linear(C, vocab_size)  # Language Modeling Head (embedding -> vocab_size)
